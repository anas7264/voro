...
const ShoppingList = () => {
  ...
  const shoppingList = useMemo(
    () => (Array.isArray(shoppingListData) ? shoppingListData : []),
    [shoppingListData],
  );
      ...
      <div className="relative max-w-4xl mx-auto px-6 py-16 md:py-24">
        <header className="mb-20 space-y-6">
          <div className="flex items-center gap-3 text-voro-primary">
            ...
            <span className="text-[0.6rem] font-black uppercase tracking-[0.4em]">
              Resource Procurement
            </span>
          </div>
          <h1 className="text-5xl md:text-6xl font-serif italic font-medium text-white tracking-tight leading-tight">
            Shopping{" "}
            <span className="text-gradient not-italic font-bold">Manifest</span>
          </h1>
        ...
        {shoppingList.length > 0 ? (
            ...
            {shoppingList.map((item, idx) => (
              ...
              >
                <button
                  ...
                  aria-label={`${item.checked ? "Unmark" : "Mark"} ${item.text} as secured`}
                  className={`relative w-6 h-6 rounded-lg border-2 flex items-center justify-center transition-all duration-500 outline-none focus-visible:ring-2 focus-visible:ring-voro-primary focus-visible:ring-offset-2 focus-visible:ring-offset-[#0A0C14] ${
                    item.checked
                ...
                <span
                  className={`flex-1 text-xl font-serif italic transition-all duration-700 ${
                    item.checked
                ...
                <div className="flex items-center gap-4 opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity">
                  ...
                  <button
                    ...
                    className="p-3 rounded-xl text-gray-700 hover:text-red-400 hover:bg-red-400/10 transition-all outline-none focus-visible:ring-2 focus-visible:ring-red-500/50 focus-visible:ring-offset-2 focus-visible:ring-offset-[#0A0C14]"
          ...
          <div className="py-32 flex flex-col items-center justify-center text-center">
            <div className="w-24 h-24 rounded-full bg-white/[0.02] border border-white/5 flex items-center justify-center mb-8 relative group">
              ...
              <Package
                size={32}
                className="text-gray-800 group-hover:text-voro-primary/50 transition-colors duration-700"
              />
            </div>
            <h3 className="text-[0.65rem] font-black text-gray-600 uppercase tracking-[0.5em] mb-2">
              Manifest Vacuum
            </h3>
            <p className="text-[0.55rem] font-mono text-gray-700 uppercase tracking-widest">
              Awaiting procurement logistics
            </p>
          </div>
        )}
      </div>
